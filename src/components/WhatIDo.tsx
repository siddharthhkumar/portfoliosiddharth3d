        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Processing large datasets, analyzing key performance indicators, building dynamic dashboards, and providing actionable business intelligence.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Conducting cross-disciplinary research, designing machine learning models for classification, evaluating analytical frameworks, and predicting outcomes.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Statistical Validation</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
